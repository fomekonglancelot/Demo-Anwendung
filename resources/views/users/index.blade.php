...
<h1 class="mt-4 ml-8"> Benutzerliste</h1>
   <a type="button" href="{{ route('users.create') }}" class="ml-3 inline-flex items-center px-8 py-2 my-5 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
    Hinzufügen
   </a>
...
<div class="mr-auto">  {{ $users->links() }}</div>
@endsection
